...
class common_fapello_xworker{
    ...
    {
        $app = [];
        $app['Weburl'] = $this->Weburl;
        $app['Title'] = $this->Title;
        $app['basedir'] = $this->basedir;
        $app['baseurl'] = $this->baseurl;
        $app['fimage'] = $this->fimage;
        $app['name'] = $this->name;
        $app['slug'] = $this->slug;
        $app['twitter'] = $this->twitter;
        $app['instagram'] = $this->instagram;
        $app['onlyfans'] = $this->onlyfans;
        $app['patreon'] =$this->patreon;
        $app['images'] = $this->images;
        $app['videos'] = $this->videos;
        return $app;
    }
