...
if(1)
{
    ...
    if(isset($model_data->id))
    {
        ...
        $image_urls = $fapello_ajax->get_new_media_url_by_model_id($model_data->id);
        $i = 0;
...
<div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0" id="post-<?php the_ID(); ?>">
    ...
    <div>
        <div class="grid grid-cols-2 gap-2 p-2">
            ...
            <a href="{$post_url}" class="col-span-2">
                <img src="{$imgs[0]}" alt="{$the_title}-1" class="rounded-md w-full lg:h-76 object-cover img_feed">
            </a>
            <a href="{$post_url}">
